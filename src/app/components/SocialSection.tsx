    ...
    >
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        <div className={`mx-auto mb-16 max-w-2xl text-center ${inView ? "fade-up" : "opacity-0"}`}>
          <p className="mb-4 text-[11px] uppercase tracking-[0.28em] text-accent" style={{ fontFamily: "'Montserrat', sans-serif" }}>
            Follow Our Journey
          </p>
          ...
          <p className="text-sm leading-7 text-muted-foreground sm:text-base" style={{ fontFamily: "'Montserrat', sans-serif" }}>
            Behind-the-scenes travel, real client journeys, and destination inspiration — curated for the discerning traveller.
          </p>
        </div>
              ...
              >
                ...
                <div className="flex items-center gap-3 border-b border-border px-5 py-4">
                  ...
                  <span
                    ...
                    style={{ color: meta.color, fontFamily: "'Montserrat', sans-serif" }}
                  >
                    {meta.label}
                  </span>
                  {post.name && (
