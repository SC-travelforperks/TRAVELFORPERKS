...
export function Hero({ onEnquire }: { onEnquire: () => void }) {
  return (
    <section className="relative h-[100svh] min-h-[560px] overflow-hidden sm:min-h-[640px]">
      ...
      <div className="relative z-10 mx-auto flex h-full max-w-6xl items-center justify-center px-5 pb-16 pt-12 text-white sm:px-8 sm:pb-0 sm:pt-28">
        <div className="relative -translate-y-3 max-w-4xl px-4 py-6 text-center sm:translate-y-0 sm:px-8 sm:py-9">
